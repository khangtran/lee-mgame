...
export default class PrivacyPage extends Component {
  render() {
    return (
      <div style={{ margin: 8 }}>
        <div style={{ backgroundColor: "black", margin: "-8px" }}>
          <div style={{ margin: "20px 10px" }}>
            <h2 style={{ color: "white" }}> Lee Cafeteria </h2>
          </div>
        </div>

        <h1>Privacy Policy</h1>

        <p>Last updated: January 15, 2020</p>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              "We", "Us" or "Our" in this Agreement) refers to Lee Loyalty.
            </p>
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to Lee Loyalty, accessible from
            leeloyalty.net
          </li>{" "}
          <li>
          ...
          <li>
            <strong>Country</strong> refers to: Viet Nam
          </li>
          <li>
            <p>
        ...
        <ul>
          <li>By email: contact@leeloyalty.net</li>
        </ul>
      </div>
    );
  }
